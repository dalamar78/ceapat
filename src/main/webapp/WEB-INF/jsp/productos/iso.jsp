...
<div class="section">
	...
	<div class="enlaces row">
		<ul>	
			<li class="glosario col-lg-6 col-md-6 col-sm-12 col-xs-12">		<a href="/productos/glosario">Búsqueda<br>de Productos por Glosario de la clasificación <abbr title="Organización Internacional de Normalización">ISO</abbr></a></li>
			<li class="iso col-lg-6 col-md-6 col-sm-12 col-xs-12">		<a href="/sipa_01/prod/iso/varias/index.htm">Búsqueda<br>de Productos por niveles <abbr title="Organización Internacional de Normalización">ISO</abbr></a></li>
		</ul>
	</div>
	</div>	
</div>
